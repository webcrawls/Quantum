...
public class PluginModule extends AbstractModule {
     ...
     */
    private final @NonNull QuantumSpawnPlugin plugin;
     ...
     */
    public PluginModule(final @NonNull QuantumSpawnPlugin plugin) {
        this.plugin = plugin;
    ...
    public void configure() {
        ...
        this.bind(QuantumSpawnPlugin.class).toInstance(this.plugin);
